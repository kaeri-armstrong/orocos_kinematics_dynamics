...
#include <armstrong_kdl/framevel.hpp>
#include <armstrong_kdl/framevel_io.hpp>
#include "PyKDL.h"
...
void init_framevel(pybind11::module &m)
{
    ...
    m.def("diff", (doubleVel (*)(const doubleVel&, const doubleVel&, double)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt")=1.0);
    m.def("addDelta", (doubleVel (*)(const doubleVel&, const doubleVel&, double)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt")=1.0);
    m.def("Equal", (bool (*)(const doubleVel&, const doubleVel&, double)) &ARMstrongKDL::Equal,
    ...
    m.def("SetToZero", (void (*)(VectorVel&)) &ARMstrongKDL::SetToZero, py::arg("vector_vel"));
    m.def("Equal", (bool (*)(const VectorVel&, const VectorVel&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const Vector&, const VectorVel&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const VectorVel&, const Vector&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);

    m.def("dot", (doubleVel (*)(const VectorVel&, const VectorVel&)) &ARMstrongKDL::dot);
    m.def("dot", (doubleVel (*)(const VectorVel&, const Vector&)) &ARMstrongKDL::dot);
    m.def("dot", (doubleVel (*)(const Vector&, const VectorVel&)) &ARMstrongKDL::dot);
    ...
    m.def("SetToZero", (void (*)(TwistVel&)) &ARMstrongKDL::SetToZero, py::arg("twist_vel"));
    m.def("Equal", (bool (*)(const TwistVel&, const TwistVel&, double)) &ARMstrongKDL::Equal,
          py::arg("a"), py::arg("b"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const Twist&, const TwistVel&, double)) &ARMstrongKDL::Equal,
          py::arg("a"), py::arg("b"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const TwistVel&, const Twist&, double)) &ARMstrongKDL::Equal,
          py::arg("a"), py::arg("b"), py::arg("eps")=epsilon);
    ...
    m.def("Equal", (bool (*)(const RotationVel&, const RotationVel&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const Rotation&, const RotationVel&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const RotationVel&, const Rotation&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    ...
    m.def("Equal", (bool (*)(const FrameVel&, const FrameVel&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const Frame&, const FrameVel&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    m.def("Equal", (bool (*)(const FrameVel&, const Frame&, double)) &ARMstrongKDL::Equal,
          py::arg("r1"), py::arg("r2"), py::arg("eps")=epsilon);
    ...
    // Global
    // --------------------
    m.def("diff", (VectorVel (*)(const VectorVel&, const VectorVel&, double)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt")=1.0);
    m.def("diff", (VectorVel (*)(const RotationVel&, const RotationVel&, double)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt")=1.0);
    m.def("diff", (TwistVel (*)(const FrameVel&, const FrameVel&, double)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt")=1.0);

    m.def("addDelta", (VectorVel (*)(const VectorVel&, const VectorVel&, double)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt")=1.0);
    m.def("addDelta", (RotationVel (*)(const RotationVel&, const VectorVel&, double)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt")=1.0);
    m.def("addDelta", (FrameVel (*)(const FrameVel&, const TwistVel&, double)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt")=1.0);
}
