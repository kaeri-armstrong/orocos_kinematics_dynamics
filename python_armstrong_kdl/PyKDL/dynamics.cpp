...
#include <iostream>
#include <iomanip>
#include <armstrong_kdl/chaindynparam.hpp>
#include <armstrong_kdl/jntspaceinertiamatrix.hpp>
...
void init_dynamics(pybind11::module &m)
{
    ...
    m.def("Add", (void (*)(const JntSpaceInertiaMatrix&, const JntSpaceInertiaMatrix&, JntSpaceInertiaMatrix&)) &ARMstrongKDL::Add, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Subtract", (void (*)(const JntSpaceInertiaMatrix&, const JntSpaceInertiaMatrix&,JntSpaceInertiaMatrix&)) &ARMstrongKDL::Subtract, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Multiply", (void (*)(const JntSpaceInertiaMatrix&, const double&, JntSpaceInertiaMatrix&)) &ARMstrongKDL::Multiply, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("Divide", (void (*)(const JntSpaceInertiaMatrix&, const double&, JntSpaceInertiaMatrix&)) &ARMstrongKDL::Divide, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("Multiply", (void (*)(const JntSpaceInertiaMatrix&, const JntArray&, JntArray&)) &ARMstrongKDL::Multiply, py::arg("src"), py::arg("vec"), py::arg("dest"));
    m.def("SetToZero", (void (*)(JntSpaceInertiaMatrix&)) &ARMstrongKDL::SetToZero, py::arg("matrix"));
    m.def("Equal", (bool (*)(const JntSpaceInertiaMatrix&, const JntSpaceInertiaMatrix&, double)) &ARMstrongKDL::Equal,
