...
#include <armstrong_kdl/frames.hpp>
#include <armstrong_kdl/frames_io.hpp>
#include "PyKDL.h"
...
void init_frames(py::module &m)
{
    ...
    m.def("SetToZero", (void (*)(Vector&)) &ARMstrongKDL::SetToZero, py::arg("vector"));
    m.def("dot", (double (*)(const Vector&, const Vector&)) &ARMstrongKDL::dot);
    m.def("Equal", (bool (*)(const Vector&, const Vector&, double)) &ARMstrongKDL::Equal,
    ...
    m.def("SetToZero", (void (*)(Wrench&)) &ARMstrongKDL::SetToZero, py::arg("wrench"));
    m.def("Equal", (bool (*)(const Wrench&, const Wrench&, double eps)) &ARMstrongKDL::Equal,
          py::arg("a"), py::arg("b"), py::arg("eps")=epsilon);
    ...
    m.def("dot", (double (*)(const Twist&, const Wrench&)) &ARMstrongKDL::dot);
    m.def("dot", (double (*)(const Wrench&, const Twist&)) &ARMstrongKDL::dot);
    m.def("SetToZero", (void (*)(Twist&)) &ARMstrongKDL::SetToZero, py::arg("twist"));
    m.def("Equal", (bool (*)(const Twist&, const Twist&, double eps)) &ARMstrongKDL::Equal,
          py::arg("a"), py::arg("b"), py::arg("eps")=epsilon);
    ...
    m.def("Equal", (bool (*)(const Rotation&, const Rotation&, double eps)) &ARMstrongKDL::Equal,
          py::arg("a"), py::arg("b"), py::arg("eps")=epsilon);
    ...
    m.def("Equal", (bool (*)(const Frame&, const Frame&, double eps)) &ARMstrongKDL::Equal,
          py::arg("a"), py::arg("b"), py::arg("eps")=epsilon);
    ...
    // Global
    // --------------------
    m.def("diff", (Vector (*)(const Vector&, const Vector&, double dt)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt") = 1);
    m.def("diff", (Vector (*)(const Rotation&, const Rotation&, double dt)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt") = 1);
    m.def("diff", (Twist (*)(const Frame&, const Frame&, double dt)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt") = 1);
    m.def("diff", (Twist (*)(const Twist&, const Twist&, double dt)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt") = 1);
    m.def("diff", (Wrench (*)(const Wrench&, const Wrench&, double dt)) &ARMstrongKDL::diff,
          py::arg("a"), py::arg("b"), py::arg("dt") = 1);
    m.def("addDelta", (Vector (*)(const Vector&, const Vector&, double dt)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt") = 1);
    m.def("addDelta", (Rotation (*)(const Rotation&, const Vector&, double dt)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt") = 1);
    m.def("addDelta", (Frame (*)(const Frame&, const Twist&, double dt)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt") = 1);
    m.def("addDelta", (Twist (*)(const Twist&, const Twist&, double dt)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt") = 1);
    m.def("addDelta", (Wrench (*)(const Wrench&, const Wrench&, double dt)) &ARMstrongKDL::addDelta,
          py::arg("a"), py::arg("da"), py::arg("dt") = 1);
}
