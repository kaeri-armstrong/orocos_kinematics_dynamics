...
#include <armstrong_kdl/joint.hpp>
#include <armstrong_kdl/rotationalinertia.hpp>
#include <armstrong_kdl/rigidbodyinertia.hpp>
#include <armstrong_kdl/chain.hpp>
#include <armstrong_kdl/tree.hpp>
#include <armstrong_kdl/jntarrayvel.hpp>
#include <armstrong_kdl/chainiksolver.hpp>
#include <armstrong_kdl/chainfksolver.hpp>
#include <armstrong_kdl/chainfksolverpos_recursive.hpp>
#include <armstrong_kdl/chainfksolvervel_recursive.hpp>
#include <armstrong_kdl/chainiksolverpos_nr.hpp>
#include <armstrong_kdl/chainiksolverpos_nr_jl.hpp>
#include <armstrong_kdl/chainiksolvervel_pinv.hpp>
#include <armstrong_kdl/chainiksolvervel_wdls.hpp>
#include <armstrong_kdl/chainiksolverpos_lma.hpp>
#include <armstrong_kdl/chainiksolvervel_pinv_nso.hpp>
#include <armstrong_kdl/chainiksolvervel_pinv_givens.hpp>
#include <armstrong_kdl/chainjnttojacsolver.hpp>
#include <armstrong_kdl/chainjnttojacdotsolver.hpp>
#include <armstrong_kdl/chainidsolver_recursive_newton_euler.hpp>
#include <armstrong_kdl/kinfam_io.hpp>
#include <armstrong_kdl/joint_mimic.hpp>
#include <armstrong_kdl/chainiksolver_vel_mimic_svd.hpp>
...
void init_kinfam(pybind11::module &m)
{
    ...
    m.def("SetToZero", (void (*)(Jacobian&)) &ARMstrongKDL::SetToZero, py::arg("jac"));
    m.def("changeRefPoint", (bool (*)(const Jacobian&, const Vector&, Jacobian&)) &ARMstrongKDL::changeRefPoint, py::arg("src"), py::arg("base"), py::arg("dest"));
    m.def("changeBase", (bool (*)(const Jacobian&, const Rotation&, Jacobian&)) &ARMstrongKDL::changeBase, py::arg("src"), py::arg("rot"), py::arg("dest"));
    m.def("changeRefFrame", (bool (*)(const Jacobian&, const Frame&, Jacobian&)) &ARMstrongKDL::changeRefFrame, py::arg("src"), py::arg("frame"), py::arg("dest"));
    ...
    m.def("Add", (void (*)(const JntArray&, const JntArray&, JntArray&)) &ARMstrongKDL::Add, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Subtract", (void (*)(const JntArray&, const JntArray&, JntArray&)) &ARMstrongKDL::Subtract, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Multiply", (void (*)(const JntArray&, const double&, JntArray&)) &ARMstrongKDL::Multiply, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("Divide", (void (*)(const JntArray&, const double&, JntArray&)) &ARMstrongKDL::Divide, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("MultiplyJacobian", (void (*)(const Jacobian&, const JntArray&, Twist&)) &ARMstrongKDL::MultiplyJacobian, py::arg("jac"), py::arg("src"), py::arg("dest"));
    m.def("SetToZero", (void (*)(JntArray&)) &ARMstrongKDL::SetToZero, py::arg("jnt_array"));
    m.def("Equal", (bool (*)(const JntArray&, const JntArray&, double)) &ARMstrongKDL::Equal,
    ...
    m.def("Add", (void (*)(const JntArrayVel&, const JntArrayVel&, JntArrayVel&)) &ARMstrongKDL::Add, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Add", (void (*)(const JntArrayVel&, const JntArray&, JntArrayVel&)) &ARMstrongKDL::Add, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Subtract", (void (*)(const JntArrayVel&, const JntArrayVel&, JntArrayVel&)) &ARMstrongKDL::Subtract, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Subtract", (void (*)(const JntArrayVel&, const JntArray&, JntArrayVel&)) &ARMstrongKDL::Subtract, py::arg("src1"), py::arg("src2"), py::arg("dest"));
    m.def("Multiply", (void (*)(const JntArrayVel&, const double&, JntArrayVel&)) &ARMstrongKDL::Multiply, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("Multiply", (void (*)(const JntArrayVel&, const doubleVel&, JntArrayVel&)) &ARMstrongKDL::Multiply, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("Divide", (void (*)(const JntArrayVel&, const double&, JntArrayVel&)) &ARMstrongKDL::Divide, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("Divide", (void (*)(const JntArrayVel&, const doubleVel&, JntArrayVel&)) &ARMstrongKDL::Divide, py::arg("src"), py::arg("factor"), py::arg("dest"));
    m.def("SetToZero", (void (*)(JntArrayVel&)) &ARMstrongKDL::SetToZero, py::arg("jnt_array_vel"));
    m.def("Equal", (bool (*)(const JntArrayVel&, const JntArrayVel&, double)) &ARMstrongKDL::Equal,
          py::arg("src1"), py::arg("src2"), py::arg("eps")=epsilon);
...
//    Not yet implemented in armstrong_kdl
