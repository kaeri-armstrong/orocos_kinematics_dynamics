...
void CompareFamilies(KinematicFamily* KF1,KinematicFamily* KF2) {
	...
	JointVector q(6);
   	q[0] = 0*ARMstrongKDL::deg2rad;
   	q[1] = 10*ARMstrongKDL::deg2rad;
   	q[2] = 20*ARMstrongKDL::deg2rad;
   	q[3] = 30*ARMstrongKDL::deg2rad;
   	q[4] = 40*ARMstrongKDL::deg2rad;
   	q[5] = 50*ARMstrongKDL::deg2rad;
	Frame F1,F2;
...
public:
	static void TestFamily(KinematicFamily* _family) {
		...
		q_initial[0] = 0*ARMstrongKDL::deg2rad;
		q_initial[1] = 0*ARMstrongKDL::deg2rad;
		q_initial[2] = 90*ARMstrongKDL::deg2rad;
		q_initial[3] = 0*ARMstrongKDL::deg2rad;
		q_initial[4] = 90*ARMstrongKDL::deg2rad;
		q_initial[5] = 0*ARMstrongKDL::deg2rad;
		...
		q[0] = -10*ARMstrongKDL::deg2rad;
   		q[1] = -10*ARMstrongKDL::deg2rad;
   		q[2] = 40*ARMstrongKDL::deg2rad;
   		q[3] = -30*ARMstrongKDL::deg2rad;
   		q[4] = 20*ARMstrongKDL::deg2rad;
   		q[5] = 60*ARMstrongKDL::deg2rad;
		testobj.test(q);
		//std::cout << "number of iterations " << ((SerialChainCartPos2Jnt*)testobj.cartpos2jnt)->iter << std::endl;
	}
...
public:
	static void TestFamily(KinematicFamily* _family) {
		...
		JointVector q(6);
   	 	...
   	 	q[5] = 50*ARMstrongKDL::deg2rad;
		testobj.test(q);
		q[0] = -50*ARMstrongKDL::deg2rad;
   	 	q[1] = -10*ARMstrongKDL::deg2rad;
   	 	q[2] = 20*ARMstrongKDL::deg2rad;
   	 	q[3] = -30*ARMstrongKDL::deg2rad;
   	 	q[4] = 20*ARMstrongKDL::deg2rad;
   	 	q[5] = 110*ARMstrongKDL::deg2rad;
		testobj.test(q);
	}
