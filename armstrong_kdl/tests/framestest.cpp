...
void FramesTest::TestRotation() {
	...
	TestOneRotation("rot([1,0,0],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(1,0,0),180*deg2rad), 180*deg2rad, Vector(1,0,0));
	// same as +180
	TestOneRotation("rot([-1,0,0],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(-1,0,0),180*deg2rad), 180*deg2rad, Vector(1,0,0));
	TestOneRotation("rot([0,1,0],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(0,1,0),180*deg2rad), 180*deg2rad, Vector(0,1,0));
	// same as +180
	TestOneRotation("rot([0,-1,0],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(0,-1,0),180*deg2rad), 180*deg2rad, Vector(0,1,0));

	TestOneRotation("rot([0,0,1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(0,0,1),180*deg2rad), 180*deg2rad, Vector(0,0,1));
	// same as +180
	TestOneRotation("rot([0,0,-1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(0,0,-1),180*deg2rad), 180*deg2rad, Vector(0,0,1));

	TestOneRotation("rot([1,0,1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(1,0,1),180*deg2rad), 180*deg2rad, Vector(1,0,1)/sqrt(2.0));
	// same as +180
	TestOneRotation("rot([1,0,1],-180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(1,0,1),-180*deg2rad), 180*deg2rad, Vector(1,0,1)/sqrt(2.0));
	TestOneRotation("rot([-1,0,-1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(-1,0,-1),180*deg2rad), 180*deg2rad, Vector(1,0,1)/sqrt(2.0));
	// same as +180
	...
	TestOneRotation("rot([1,1,0],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(1,1,0),180*deg2rad), 180*deg2rad, Vector(1,1,0)/sqrt(2.0));
	// opposite of +180
	TestOneRotation("rot([1,1,0],-180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(1,1,0),-180*deg2rad), 180*deg2rad, Vector(1,1,0)/sqrt(2.0));
	TestOneRotation("rot([-1,-1,0],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(-1,-1,0),180*deg2rad), 180*deg2rad, Vector(1,1,0)/sqrt(2.0));
	// opposite of +180
	...
	TestOneRotation("rot([0,1,1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(0,1,1),180*deg2rad), 180*deg2rad, Vector(0,1,1)/sqrt(2.0));
	// same as +180
	TestOneRotation("rot([0,1,1],-180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(0,1,1),-180*deg2rad), 180*deg2rad, Vector(0,1,1)/sqrt(2.0));
	TestOneRotation("rot([0,-1,-1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(0,-1,-1),180*deg2rad), 180*deg2rad, Vector(0,1,1)/sqrt(2.0));
	// same as +180
	...
	TestOneRotation("rot([1,1,1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(1,1,1),180*deg2rad), 180*deg2rad, Vector(1,1,1)/sqrt(3.0));
	// same as +180
	TestOneRotation("rot([1,1,1],-180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(1,1,1),-180*deg2rad), 180*deg2rad, Vector(1,1,1)/sqrt(3.0));
	TestOneRotation("rot([-1,-1,-1],180)", ARMstrongKDL::Rotation::Rot(ARMstrongKDL::Vector(-1,-1,-1),180*deg2rad), 180*deg2rad, Vector(1,1,1)/sqrt(3.0));
	// same as +180
	...
	TestOneRotation("rot([0.707107, 0, 0.707107", ARMstrongKDL::Rotation::RPY(-2.9811968953315162, -atan(1)*2, -0.1603957582582825), 180*deg2rad, Vector(0.707107,0,0.707107) );
...
void FramesTest::TestGetRotAngle() {
    ...
    // rpy -> rotation
    ARMstrongKDL::Rotation kdlRotation1 = ARMstrongKDL::Rotation::RPY(roll, pitch, yaw);

    // rotation -> angle-axis (with ARMstrongKDL::GetRotAngle)
    ARMstrongKDL::Vector kdlAxis;
  ...
  {
    Vector axis;
    double angle = ARMstrongKDL::Rotation( 1, 0, 0 + 1e-6, 0, 1, 0, 0, 0,  1 + 1e-6).GetRotAngle(axis);
  ...
  // an improper rotation matrix corresponds to a rotation between a right-hand and left-hand coordinate system
  {
    ...
    R = ARMstrongKDL::Rotation( 0, -1, 0, 0, 0, -1, -1, 0, 0);
...
void FramesTest::TestRotationDiff() {
    ...
    ARMstrongKDL::Rotation R1 = Rotation::RPY(+5*deg2rad,0,-90*deg2rad);
