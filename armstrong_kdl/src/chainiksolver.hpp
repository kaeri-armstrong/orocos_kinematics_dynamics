...
namespace ARMstrongKDL {
    ...
    /**
	  ...
	  * position solver for a ARMstrongKDL::Chain.
     *
     * @ingroup KinematicFamily
     */
    class ChainIkSolverPos : public ARMstrongKDL::SolverI {
    public:
        /**
    ...
    /**
	  * \brief This <strong>abstract</strong> class encapsulates the inverse
	  * velocity solver for a ARMstrongKDL::Chain.
     *
     * @ingroup KinematicFamily
     */
    class ChainIkSolverVel : public ARMstrongKDL::SolverI {
    public:
        /**
    ...
    /**
	  * \brief This <strong>abstract</strong> class encapsulates the inverse
	  * acceleration solver for a ARMstrongKDL::Chain.
     *
     * @ingroup KinematicFamily
     */

    class ChainIkSolverAcc : public ARMstrongKDL::SolverI {
    public:
        /**
