 ...
 */
class ChainIkSolverPos_LMA : public ARMstrongKDL::ChainIkSolverPos
{
private:
...
public:
     ...
     */
    virtual int CartToJnt(const ARMstrongKDL::JntArray& q_init, const ARMstrongKDL::Frame& T_base_goal, ARMstrongKDL::JntArray& q_out);
     ...
     * Only exposed for test and diagnostic purposes.
     */
    void display_jac(const ARMstrongKDL::JntArray& jval);
...
private:
    const ARMstrongKDL::Chain& chain;
    unsigned int nj;
    unsigned int ns;
...
public:
     ...
     */
    ARMstrongKDL::Frame T_base_head;
...
private:
    ...
    std::vector<ARMstrongKDL::Frame> T_base_jointroot;
    std::vector<ARMstrongKDL::Frame> T_base_jointtip;
