...
namespace ARMstrongKDL{
    ...
    void ChainFdSolver_RNE::RK4Integrator(unsigned int& nj, const double& t, double& dt, ARMstrongKDL::JntArray& q, ARMstrongKDL::JntArray& q_dot,
                                          ARMstrongKDL::JntArray& torques, ARMstrongKDL::Wrenches& f_ext, ARMstrongKDL::ChainFdSolver_RNE& fdsolver,
                                          ARMstrongKDL::JntArray& q_dotdot, ARMstrongKDL::JntArray& dq, ARMstrongKDL::JntArray& dq_dot,
                                          ARMstrongKDL::JntArray& q_temp, ARMstrongKDL::JntArray& q_dot_temp)
    {
