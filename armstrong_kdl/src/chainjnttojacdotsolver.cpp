...
const Twist& ChainJntToJacDotSolver::getPartialDerivative(const ARMstrongKDL::Jacobian& J,
...
const Twist& ChainJntToJacDotSolver::getPartialDerivativeHybrid(const ARMstrongKDL::Jacobian& bs_J_ee,
                                                                const unsigned int& joint_idx,
                                                                const unsigned int& column_idx)
{
    int j=joint_idx;
...
const Twist& ChainJntToJacDotSolver::getPartialDerivativeInertial(const ARMstrongKDL::Jacobian& bs_J_bs,
                                                                  const unsigned int& joint_idx,
                                                                  const unsigned int& column_idx)
{
    int j=joint_idx;
