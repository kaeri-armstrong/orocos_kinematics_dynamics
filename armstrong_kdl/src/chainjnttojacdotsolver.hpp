...
public:
     ...
     */
    virtual int JntToJacDot(const ARMstrongKDL::JntArrayVel& q_in, ARMstrongKDL::Twist& jac_dot_q_dot, int seg_nr = -1);
    /**
     ...
     * @return int 0 if no errors happened
     */
    virtual int JntToJacDot(const ARMstrongKDL::JntArrayVel& q_in, ARMstrongKDL::Jacobian& jdot, int seg_nr = -1);
