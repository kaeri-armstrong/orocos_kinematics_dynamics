...
namespace ARMstrongKDL {
    ...
    /**
	  ...
	  * solver for the forward position kinematics for a ARMstrongKDL::Tree.
     *
    ...
    public:
        /**
         * Calculate forward position kinematics for a ARMstrongKDL::Tree,
     ...
     * for the forward velocity kinematics for a ARMstrongKDL::Tree.
     *
     * @ingroup KinematicFamily
     */
...
//    };
    ...
    /**
     * \brief This <strong>abstract</strong> class encapsulates a solver
     * for the forward acceleration kinematics for a ARMstrongKDL::Tree.
     *
     * @ingroup KinematicFamily
     */
