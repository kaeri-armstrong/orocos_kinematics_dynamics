...
namespace
{
unsigned int countMimicJoints(const std::vector<ARMstrongKDL::JointMimic>& mimic_joints)
{
...
ChainIkSolverVelMimicSVD::ChainIkSolverVelMimicSVD(const Chain& chain,
                                                   const std::vector<JointMimic>& mimic_joints,
...
int ChainIkSolverVelMimicSVD::setWeightJS(const Eigen::VectorXd& Mq){
...
int ChainIkSolverVelMimicSVD::setWeightTS(const Eigen::MatrixXd& Mx){
