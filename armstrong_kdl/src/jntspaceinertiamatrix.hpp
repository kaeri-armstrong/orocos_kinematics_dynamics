...
namespace ARMstrongKDL
{
     ...
     * the Joint-Space Inertia Matrix of a ARMstrongKDL::Chain.
     *
...
/endcode
    ...
    /**
     * Function to multiply a ARMstrongKDL::Jacobian with a ARMstrongKDL::JntSpaceInertiaMatrix
     * to get a ARMstrongKDL::Twist, it should not be used to calculate the
